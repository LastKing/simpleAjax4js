...
describe('带参数测试', ()=> {
    ...
    it('参数为布尔', (done)=> {
        request(app)
            .get('/simpleajax/with_args/getBoolean.ac?args=[false]')
            .expect(200)
    ...
    it('参数为数字', (done)=> {
        request(app)
            .get('/simpleajax/with_args/getNumber.ac?args=[2.14]')
            .expect(200)
            .expect('Content-Type', 'application/json; charset=utf-8')
            .end((err, res)=> {
                if (err)done(err);
    ...
    it('参数为字符串', (done)=> {
        request(app)
            .get('/simpleajax/with_args/getString.ac?args=["eazy"]')
            .expect(200)
            .expect('Content-Type', 'application/json; charset=utf-8')
            .end((err, res)=> {
                if (err)done(err);
    ...
    it('参数为数组,返回承诺', (done)=> {
        request(app)
            .get('/simpleajax/with_args/getArray.ac?args=[[1,2,3,4,"six",null]]')
            .expect(200)
            .expect('Content-Type', 'application/json; charset=utf-8')
            .end((err, res)=> {
                if (err)done(err);
    ...
    it('参数为对象,返回承诺', (done)=> {
        request(app)
            .get('/simpleajax/with_args/getObject.ac?args=[{"name":"eazyajax"}]')
            .expect(200)
            .expect('Content-Type', 'application/json; charset=utf-8')
            .end((err, res)=> {
                if (err)done(err);
    ...
    it('参数为时间,返回承诺', (done)=> {
        request(app)
            .get('/simpleajax/with_args/getDate.ac?args=["2016-01-01T12:00:00.126Z"]')
            .expect(200)
            .expect('Content-Type', 'application/json; charset=utf-8')
            .end((err, res)=> {
                if (err)done(err);
